...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Poppins:wght@400;700&display=swap" rel="stylesheet">
</head>
<body>
  ...
  <nav class="container">
    ...
    <ul id="Primary-menu">
      ...
      <li><a href="#">
        <img src="assets/Profile pic.png" alt="Imagen de Isabela Torres">
      </a>
    </li>
    </ul>
  </nav>
    ...
    <header>
      <div class="container">
        <div class="id">Profile
          <img src="assets/Profile pic.png" alt="Imagem de isabela torre">
          <div>
  ...
  <ul id="info">
    ...
    <li>
      <img src="assets/icons/AirplaneTilt.svg" alt="ícone de aviao">
      <span>37 países</span>
    </li>
    <li>
